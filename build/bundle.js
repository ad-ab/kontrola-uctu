...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	let t3;
    	let div2;
    	let t4_value = (/*secondResult*/ ctx[2] ? "Ok" : "Chyba") + "";
    	let t4;
    	...
    	const block = {
    		c: function create() {
    			...
    			div2 = element("div");
    			t4 = text(t4_value);
    			attr_dev(div0, "class", "svelte-cpogbp");
    			add_location(div0, file, 29, 2, 458);
    			attr_dev(div1, "class", "center svelte-cpogbp");
    			add_location(div1, file, 30, 2, 482);
    			attr_dev(div2, "class", "center svelte-cpogbp");
    			add_location(div2, file, 31, 2, 537);

    			attr_dev(div3, "class", div3_class_value = "" + (null_to_empty(/*result*/ ctx[1] && /*secondResult*/ ctx[2]
    			? "good"
    			: "bad") + " svelte-cpogbp"));

    			add_location(div3, file, 28, 0, 401);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*secondResult*/ 4 && t4_value !== (t4_value = (/*secondResult*/ ctx[2] ? "Ok" : "Chyba") + "")) set_data_dev(t4, t4_value);

    			if (dirty & /*result, secondResult*/ 6 && div3_class_value !== (div3_class_value = "" + (null_to_empty(/*result*/ ctx[1] && /*secondResult*/ ctx[2]
    			? "good"
    			: "bad") + " svelte-cpogbp"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { account } = $$props;
    	let { result } = $$props;
    	let { secondResult } = $$props;
    	const writable_props = ["account", "result", "secondResult"];
    	...
    	$$self.$set = $$props => {
    		...
    		if ("secondResult" in $$props) $$invalidate(2, secondResult = $$props.secondResult);
    	};

    	$$self.$capture_state = () => ({ account, result, secondResult });
    	...
    	return [account, result, secondResult];
    }

    class ResultRow extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { account: 0, result: 1, secondResult: 2 });
    		...
    		if (/*secondResult*/ ctx[2] === undefined && !("secondResult" in props)) {
    			console.warn("<ResultRow> was created without expected prop 'secondResult'");
    		}
    	}
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 118, 8, 2334);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "class", "svelte-g5h9li");
    			add_location(input, file$1, 121, 12, 2408);
    			attr_dev(label, "class", "svelte-g5h9li");
    			add_location(label, file$1, 120, 10, 2388);
    			attr_dev(div0, "class", "row svelte-g5h9li");
    			add_location(div0, file$1, 119, 8, 2360);
    			attr_dev(div1, "class", "results svelte-g5h9li");
    			add_location(div1, file$1, 126, 8, 2536);
    			attr_dev(form, "class", "svelte-g5h9li");
    			add_location(form, file$1, 117, 6, 2275);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(117:4) {#if resultItems.length}",
    		ctx
    	});
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$1, 134, 12, 2795);
    		},
    		m: function mount(target, anchor) {
    ...
    // (129:12) {#each filteredResult as item}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 129, 14, 2642);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(129:12) {#each filteredResult as item}",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*resultItems, errorsOnly*/ 6) {
    			 $$invalidate(3, filteredResult = resultItems.filter(x => !errorsOnly || (!x.result || !x.secondResult)));
    		}
